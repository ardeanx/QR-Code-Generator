    ...
    $.fn.extend({
        ...
        qrcdr: function(options) {
            ...
            return this.each(function() {
                ...
                generate_qrcode_btn = obj.find('.generate_qrcode'); // #Kirim & Simpan
                ...
                // metode yang akan digunakan di luar plugin
                ...
                // Perbarui preview saat perubahan
                ...
                /*
                 * Membuat SVG dan tombol download
                 */
                function saveCode(){
                ...
                function createPng() {
                    ...
                    preloader.fadeIn(100, function(){
                        ...
                        newImg.onload = function() {
                            ...
                            setTimeout(function(){ // Perbaikan untuk Safari gambar yang hilang?
                        ...
                        newImg.src = imgSrc; // ini harus dilakukan SETELAH pengaturan onload
                    });
                }
                ...
                upmarker.on('change', function(e){
                    ...
                    if (this.files[0].type.match('image.*')) {
                        ...
                        reader.onload = function (e) {
                            ...
                            // Perbarui Opsi Watermark Khusus
                ...
                function loadGeolocator(geomap_id, geomarker_id) {
                    ...
                    if ( $( "#wpol-admin-map" ).length ) {
                        ...
                        // Mendapatkan Kordinat dari alamat.
                ...
                imageeditor.cropit({
                    ...
                    imageBackgroundBorderWidth: 25, // Lebar batas latar belakang
                ...
                // Saat pengguna mengklik tombol pilih gambar,
                // membuka dialog pemilihan file secara terprogram
