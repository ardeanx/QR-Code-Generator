...
if (!class_exists('QRcdrFn', false)) {
    ...
    class QRcdrFn
    {
        ...
        /**
         * Mendapatkan String yang diterjemahkan
         *
         * @param string $string kunci untuk mencari
         *
        ...
        /**
         * Mendapatkan nilai Config
         *
         * @param string $key     kunci untuk mencari
         ...
         * Hapus file lama
         *
         * @param string $dir direktori untuk di scan
         * @param int    $age files lifetime
         * @param str    $ext file ekstensi: svg, png
         *
         * @return a bersihkan direktori
         */
         ...
         * Menu Bahasa
         *
         * @param string $type  output menu tersedia: 'menu' | 'list'
         * @param string $class class opsional untuk ditambahkan
         *
         * @return the menu bahasa
         */
        ...
        /**
         * Konversikan warna HEX
         *
         *@param string $colorCode    warna untuk dikonversikan
         * @param string $defaultcolor warna default
         *
         * @return converted color
         */
        public function hexdecColor($colorCode, $defaultcolor = '#000000')
        {
            // Jika pengguna secara tidak sengaja memberikan tanda #, hapus tanda tersebut
        ...
        /**
         * Menambah atau mengurangi kecerahan warna sebesar persentase kecerahan saat ini.
         *
         * @param string $hexCode       Format didukung: `#FFF`, `#FFFFFF`, `FFF`, `FFFFFF`
         * @param float  $adjustPercent Nomor diantara -1 and 1. E.g. 0.3 = 30% lighter; -0.4 = 40% darker.
         *
         * @return string
         */
    ...
    /**
     * Fungsi Helper untuk mendapatkan/mengembalikan objek QRcdrFn
     *
